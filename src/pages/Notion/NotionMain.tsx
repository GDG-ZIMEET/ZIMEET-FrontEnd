...
const NotionMain: React.FC = () => {
    ...
    switch (pathname) {
        case '/notion/randomMeetingHelp':
            ...
            component = (
                <iframe src="https://efficacious-ease-5ad.notion.site/1a54f19e53cc80cdb5f5d25888cd8dd0?pvs=4" 
                        width="100%" 
                        height="900" />
            );
            break;
        ...
        case '/notion/termsOfService':
            headerTitle = "이용약관";
            component = (
                <iframe src="https://efficacious-ease-5ad.notion.site/1a54f19e53cc808ba060d7d16a306fef?pvs=4" 
                        width="100%" 
                        height="900" />
            );
            break;
        ...
        case '/notion/notificationSetting':
            ...
            component = (
                <iframe src="https://efficacious-ease-5ad.notion.site/1a54f19e53cc808fa6c1d7039d83d047?pvs=4" 
                        width="100%" 
                        height="900" />
            );
            break;
        case '/notion/meetingGuide':
            ...
            component = (
                <iframe src="https://efficacious-ease-5ad.notion.site/cda2ace51cca4000b25ad29f3be094a6?pvs=4" 
                        width="100%" 
                        height="900" />
            );
            break;
        ...
        case '/notion/developmentTeam':
            ...
            component = (
                <iframe src="https://efficacious-ease-5ad.notion.site/ZI-1a54f19e53cc80369c03d332008d5768?pvs=4" 
                        width="100%" 
                        height="900" />
            );
            break;   
