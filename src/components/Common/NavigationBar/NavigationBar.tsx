...
const NavigationBar = () => {
  ...
  type Path = '/' | '/chattingInventory' | '/mypage' | '/setlist';
  const iconMapping: Record<
    Path,
    { selected: JSX.Element; default: JSX.Element }
  > = {
    '/': {
  ...
  return (
    <S.NavBarContainer>
      ...
      >
        <S.IconWrapper>{getIcon('/chattingInventory')}</S.IconWrapper>
        채팅
      </S.NavItem>
      <S.NavItem
        onClick={() => {
      ...
      >
        <S.IconWrapper>{getIcon('/setlist')}</S.IconWrapper>
        공연
      </S.NavItem>
      <S.NavItem
        onClick={() => {
      ...
      >
        <S.IconWrapper>{getIcon('/mypage')}</S.IconWrapper>
        내정보
      </S.NavItem>
    </S.NavBarContainer>
  );
